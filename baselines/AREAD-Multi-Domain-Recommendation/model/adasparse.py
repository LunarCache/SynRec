...
# -*- coding: utf-8 -*-
"""
# @Paper: Yang, Xuanhua, et al. "Adasparse: Learning adaptively sparse structures for multi-domain click-through rate
          prediction." Proceedings of the 31st ACM International Conference on Information & Knowledge Management. 2022.
...
class AdaSparse(BaseModel):
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict,
                 hidden_dims, domain_idx=None,
                 dropout=0.2, config=None,
                 l2_reg_embedding=1e-5, l2_reg_linear=1e-5, l2_reg_dnn=1e-5, l2_reg_cross=1e-5):
        super(AdaSparse, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
                                        l2_reg_embedding=l2_reg_embedding, l2_reg_linear=l2_reg_linear)
        self.model_name = 'adasparse'
