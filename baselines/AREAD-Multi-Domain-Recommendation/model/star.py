...
# -*- coding: utf-8 -*-
"""
# @Paper: Sheng, Xiang-Rong, et al. "One model to serve all: Star topology adaptive recommender for multi-domain ctr
          prediction." Proceedings of the 30th ACM International Conference on Information & Knowledge Management. 2021.
# @Code : https://github.com/qwerfdsaplking/SATrans
"""
...
class STAR(BaseModel):
    ...
    def __init__(self, one_hot_feature_dims, embed_dim,
                 multi_hot_dict, n_tower, tower_dims, domain_idx=None, dropout=0.2, config=None,
                 l2_reg_embedding=1e-5, l2_reg_linear=1e-5, l2_reg_dnn=1e-5, l2_reg_cross=1e-5, device=None):
        super(STAR, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
        ...
        print(f"STAR use_dcn: {self.use_dcn}")
        print(f"STAR use_atten: {self.use_atten}")
