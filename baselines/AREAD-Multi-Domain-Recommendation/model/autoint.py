...
# -*- coding: utf-8 -*-
"""
# @Paper: Song, Weiping, et al. "Autoint: Automatic feature interaction learning via self-attentive neural networks."
...
class AutoInt(BaseModel):
    ...
    """
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict, atten_embed_dim=None, att_layer_num=3,
                 att_head_num=2, att_res=True, mlp_dims=(256, 128), dropout=0.2,
                 l2_reg_embedding=1e-5, l2_reg_linear=1e-5, l2_reg_dnn=1e-5):

        super(AutoInt, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
