...
# -*- coding: utf-8 -*-
"""
# @Paper: Tang, Hongyan, et al. "Progressive layered extraction (ple): A novel multi-task learning (mtl) model for
          personalized recommendations." Proceedings of the 14th ACM Conference on Recommender Systems. 2020.
# @Code : https://github.com/datawhalechina/torch-rechub/
"""
...
class PLE(BaseModel):
    ...
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict, n_tower,
        ...
        super(PLE, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
