...
# -*- coding: utf-8 -*-
"""
# @Paper: Wang, Ruoxi, et al. "Dcn v2: Improved deep & cross network and practical lessons for web-scale learning to
          rank systems." Proceedings of the web conference 2021. 2021.
...
class DCNv2(BaseModel):
    ...
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict, n_cross_layers, mlp_dims, dropout=0.2,
        ...
        super(DCNv2, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
