...
# -*- coding: utf-8 -*-
"""
# @Paper: Zhou, Jie, et al. "Hinet: Novel multi-scenario & multi-task learning with hierarchical information
          extraction." 2023 IEEE 39th International Conference on Data Engineering (ICDE). IEEE, 2023.
# @Code : https://github.com/mrchor/HiNet
"""
...
class HiNet(BaseModel):
    def __init__(self,  one_hot_feature_dims, embed_dim, multi_hot_dict, n_tower=6, sei_dims=None, tower_dims=None,
        ...
        super(HiNet, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
                                    l2_reg_embedding=l2_reg_embedding, l2_reg_linear=l2_reg_linear)
        self.model_name = 'hinet'
