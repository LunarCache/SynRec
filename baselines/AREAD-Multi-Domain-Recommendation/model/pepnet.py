...
# -*- coding: utf-8 -*-
"""
# @Paper: Chang, Jianxin, et al. "Pepnet: Parameter and embedding personalized network for infusing with personalized
          prior information." Proceedings of the 29th ACM SIGKDD Conference on Knowledge Discovery and Data Mining. 2023.
# @Code : https://github.com/reczoo/FuxiCTR
"""
...
class PEPNet(BaseModel):
    ...
    """
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict, n_tower, tower_dims, gate_hidden_dim=64,
        ...
        super(PEPNet, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
