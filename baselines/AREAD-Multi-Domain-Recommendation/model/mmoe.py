...
# -*- coding: utf-8 -*-
"""
# @Paper: Ma, Jiaqi, et al. "Modeling task relationships in multi-task learning with multi-gate mixture-of-experts."
...
class MMoE(BaseModel):
    ...
    """
    def __init__(self, one_hot_feature_dims, embed_dim, multi_hot_dict, n_tower, n_expert,
                 expert_dims, tower_dims, dropout=0.2, config=None,
                 l2_reg_embedding=1e-5, l2_reg_linear=1e-5, l2_reg_dnn=1e-5, l2_reg_cross=1e-5):
        super(MMoE, self).__init__(one_hot_feature_dims, embed_dim, multi_hot_dict,
